...
# Naver OpenAPI에서 블로그 검색을 위한 요청 주소를 작성
searchUrl = "https://openapi.naver.com/v1/search/blog.xml"
Client_ID = "2eRUMqUIErG_goZrLd0v"
Client_Secret = "ylPUGU1rW7"

# 검색하고자 하는 키워드가 한글일 경우 UTF-8로 인코딩 설정
query = URLencode(iconv("일본여행", "UTF-8"))

# 변수에 저장된 searchUrl, Client_ID, Client_Secret, query를 하나의 URL로 생성
url = paste(searchUrl, "?query=", query, "&display=20", sep = "")
url

# url을 사용해서 검색한 결과 페이지를 요청하여 반환
